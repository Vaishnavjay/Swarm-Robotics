        ...
        for j in range(0, 3):
            if len(finalpos[i][j]) == 0:
                if i == 1 and j == 1 and len(finalpos[1][0]) is not 0:
                    ...
                    flag = 1
               # elif i==1 and j==1 and len(finalpos[1][0])is 0 and len(finalpos[2][1]) is not 0
                    ...
                    if len(finalpos[1][1]) is not 0:
                        cv2.line(can1, pos[i][j][0], (pos[i][j][0][0], 30), (0, 255, 0), 2)
                        pos[i][j] = [(pos[i][j][0][0], 30)]
                    elif len(finalpos[1][1])==0 and pos[1][0][0][1] is not pos[1][1][0][1]:
                        cv2.line(can1, pos[i][j][0], (pos[i][j][0][0]+50, 30), (0, 255, 0), 2)
                        pos[i][j] = [(pos[i][j][0][0]+50, 30)]
                elif i == 1 and j == 2:
                ...
                if len(finalpos[1][0])>0 and len(finalpos[1][1])==0and i==1 and j==0:
                    cv2.line(can1,pos[1][0][0] , (pos[1][0][0][0], 30), (0, 255, 0), 2)
                    pos[1][0] = [(pos[1][0][0][0], 30)]
